...
unzipped=imresize(zipped1,[90,90]);
figure,
imshow(unzipped);
...
d= reshape(d,132,132);
n2=uint8(c);
figure,imshow(n2,[]),title('decoded image');
n3=uint8(d);

figure,imshow(n3,[]),title('Decoded Image');
save compressed c d


Final = idwt2(approximation,horizontal,vertical,d,'bior4.4');
figure(13);
save  
